...
public class AddHallFormController implements Initializable {
    ...
    public void setDialog(Dialog<ButtonType> dialog) {
        this.dialog = dialog;
        // Update the window title if we're in edit mode
        if (isEditMode && dialog != null) {
    ...
    @FXML private ComboBox<HallType> hallTypeComboBox;
    @FXML private TextField capacityField;
    @FXML private TextField ratePerHourField;
    ...
    /**
     * Reference to the dialog containing this form
     * Used to update dialog properties like title and handle dialog-specific operations
     */
...
// Window title is now handled by the setDialog method
    ...
    private void setupDialogValidation() {
        ...
        try {
            ...
            if (saveButton != null) {
                ...
                hallTypeComboBox.valueProperty().addListener((obs, oldVal, newVal) -> updateSaveButtonState(saveButton));
    ...
    private void generateHallId() {
        // Generate a simple timestamp-based ID (can be replaced with a more sophisticated ID generator)
